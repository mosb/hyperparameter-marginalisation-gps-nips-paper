...
\begin{equation}
\tK(\mathbf{x},\mathbf{x})=\int_\theta \left[\int_{\mathbf{f}} \mathbf{f}\  \mathbf{f}^T p(\mathbf{f}\mid \bm{\theta}) p(\bm{\theta}) d\mathbf{f} \right] d\bm{\theta}=\int_\theta K_{\bm{\theta}}(\mathbf{x},\mathbf{x}) p(\bm{\theta}) d\bm{\theta}
\end{equation}
...
\begin{equation}
 K'_\phi = \left(1 + \frac{\Delta^2}{2 \alpha L^2} \right)^{-\alpha} = \int_L K_{L}(\mathbf{x},\mathbf{x}) p(\bm{\theta}) d\bm{\theta}
\end{equation}
