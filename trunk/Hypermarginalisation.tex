...
\begin{align}
p(\mathbf{f} | \mathbf{x},\bm{\theta},I) &:= \mathcal{N}\left( \mathbf{f};\mu(\mathbf{x},\bm{\theta}),K(\mathbf{x},\mathbf{x},\bm{\theta}) \right) \\
...
%Observations
Once observations of the function are available, these can be incorporated 
